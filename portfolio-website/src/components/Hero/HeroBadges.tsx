...
export function HeroBadges({ yearsOfExperience, location, availability }: HeroBadgesProps) {
  return (
    <div className="flex flex-wrap justify-center gap-4 mb-6">
      <div className="flex items-center gap-2 bg-blue-500/10 text-accent px-4 py-2 rounded-full border border-blue-500/20 transition-all duration-200 hover:bg-blue-500/20 hover:scale-105">
        ...
        <span className="font-medium">{yearsOfExperience} experience</span>
      </div>
      ...
      {availability && (
        <div className="flex items-center gap-2 bg-green-500/10 text-green-600 px-4 py-2 rounded-full border border-green-500/20 transition-all duration-200 hover:bg-green-500/20 hover:scale-105">
